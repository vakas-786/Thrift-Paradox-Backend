...
Transaction.create(item: "Water Bill", type_trans: "Expense", category: "Bills/Utilties", amount: 90.46, date: Faker::Date.between(from: '2020-01-01', to: '2020-09-30'), account_id: Account.all.first.id)
Transaction.create(item: "Phone Bill", type_trans: "Expense", category: "Bills/Utilties", amount: 80.47, date: Faker::Date.between(from: '2020-01-01', to: '2020-09-30'), account_id: Account.all.first.id)
Transaction.create(item: "Cable Bill", type_trans: "Expense", category: "Bills/Utilties", amount: 70.25, date: Faker::Date.between(from: '2020-01-01', to: '2020-09-30'), account_id: Account.all.first.id)
Transaction.create(item: "Healthcare", type_trans: "Expense", category: "Bills/Utilties", amount: 91.00, date: Faker::Date.between(from: '2020-01-01', to: '2020-09-30'), account_id: Account.all.first.id)
Transaction.create(item: "Car Repair", type_trans: "Expense", category: "Bills/Utilties", amount: 122.34, date: Faker::Date.between(from: '2020-01-01', to: '2020-09-30'), account_id: Account.all.first.id)
